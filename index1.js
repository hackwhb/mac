...
function refreshImg() {
  ...
  var verImg = $('.verImg')
  if (verImg.length) {
    verImg.attr('src', `https://cdn.jsdelivr.net/gh/hackwhb/mac@1.4/imgs/${imgs[index]}.jpg`)
  } else {
    imgBox.prepend(`<img class='verImg' src="https://cdn.jsdelivr.net/gh/hackwhb/mac@1.4/imgs/${imgs[index]}.jpg" />`)
  }
  verify.css('background-image', `url('https://cdn.jsdelivr.net/gh/hackwhb/mac@1.4/imgs/${imgs[index]}.jpg')`)
}
